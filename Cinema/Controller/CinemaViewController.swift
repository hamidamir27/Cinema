...
class CinemaViewController : ObservableObject{
    
    //Array Of Cinemas
    @Published var cinemas : [Cinema]
    
    //Dummy data
    var earlwoodMovies: [Movie] = [
        Movie(
            image: "kungfupanda",
            title: "Kung Fu Panda",
        ...
        Movie(
            ...
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 7 == 0) }
        ),
        Movie(
            image: "civilwar",
        ...
        Movie(
            ...
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 6 == 0) }
        ...
        Movie(
            ...
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 5 == 0) }
        ),
        Movie(
            image: "ghostbusters",
            title: "Ghostbusters",
        ...
        Movie(
            ...
            category: ["Vintage", "Most Popular"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
            image: "bluesbrothers",
        ...
        Movie(
            ...
            category: ["Vintage"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 9 == 0) }
        ),
        Movie(
            image: "footloose",
            title: "Footloose",
    ...
    var chatswoodMovies : [Movie] = [
        Movie(
            image: "fallguy",
            title: "Fall Guy",
            subtitle: "After leaving the business one year earlier, battle-scarred stuntman Colt Seavers springs back into action when the star of a big studio movie suddenly disappears",
        ...
        Movie(
            ...
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 10 == 0) }
        ),
        Movie(
            image: "amywinehouse",
            title: "Amy",
            ...
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 8 == 0) }
        ),
        Movie(
            image: "monkeyman",
            title: "Monkey Man",
        ...
        Movie(
            ...
            category: ["New Release", "Most Popular"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 2 == 0) }
        ),
        Movie(
            image: "clueless",
            title: "Clueless",
    ...
    var georgeStreetMovies: [Movie] = [
        Movie(
            image: "dune2",
            title: "Dune 2",
            subtitle: "Paul Atreides unites with Chani and the Fremen while seeking revenge against the conspirators who destroyed his family",
            showTimes: ["2024-05-01": ["1:00 PM", "4:00 PM", "7:00 PM"]],
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
        ...
        Movie(
            ...
            title: "The Blues Brothers",
            subtitle: "When they learn that their childhood orphanage is about to be torn down, brothers Jake and Elwood Blues set out to save it by reuniting their old R & B band for a fundraising performance.",
            showTimes: ["2024-05-03": ["11:00 AM", "2:00 PM", "5:00 PM"]],
            category: ["Vintage"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
            ...
            title: "Amy",
            subtitle: "The life and times of Amy Winehouse.",
            showTimes: ["2024-05-04": ["12:00 PM", "3:00 PM", "6:00 PM"]],
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
            ...
            title: "10 Things I Hate About You",
            subtitle: "As soon as Cameron, a newbie at Padua High School, finds Bianca, he falls in love with her. However, to date Bianca, he must first get her older sister Kate, a mean feminist, to date someone.",
            showTimes: ["2024-05-05": ["1:00 PM", "4:00 PM", "7:00 PM"]],
            category: ["Vintage", "Most Popular"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        )
    ]
    var eastLakesMovies: [Movie] = [
        Movie(
            image: "ferrisbuellers",
            title: "Ferris Buellers Day Off",
            subtitle: "Ferris Bueller, a high school student, fakes sickness to stay at home and spends the rest of the day with his best friend and girlfriend. Meanwhile, his dean tries to spy on him.",
        ...
        Movie(
            ...
            title: "Clueless",
            subtitle: "a 1995 American coming-of-age teen comedy film written and directed by Amy Heckerling",
            showTimes: ["2024-05-02": ["12:00 PM", "3:00 PM", "6:00 PM"]],
            category: ["Vintage"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
            ...
            title: "Kung Fu Panda",
            subtitle: "A clumsy panda learns martial arts.",
            showTimes: ["2024-05-03": ["10:00 AM", "1:00 PM", "4:00 PM"]],
            category: ["New Release"],
            seats: (1...30).map { Seat(id: "Seat \($0)", isOccupied: $0 % 4 == 0) }
        ),
        Movie(
    ...
    init(){
        let earlwood = Cinema(movies: earlwoodMovies, name: "Earlwood")
        let georgestreet = Cinema(movies: georgeStreetMovies, name: "George Street")
        let chatswood = Cinema(movies: chatswoodMovies, name: "Chatswood")
        let eastlakes = Cinema(movies: eastLakesMovies, name: "Eastlakes")
        cinemas = [earlwood, georgestreet, chatswood, eastlakes]
    }
    
    //Pass the object to homeView

    
    //Cinema view has a link to ticketView
